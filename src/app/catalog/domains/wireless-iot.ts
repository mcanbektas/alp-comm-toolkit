      ...
      protocols: [
        {
          ...
          name: 'Wi-Fi',
          summary:
            'IEEE 802.11 wireless LAN whose management, control and data frames are analysed from PCAP or monitor-mode captures to explain association, roaming and retry behaviour. DECODED: the bare MAC frame with its 4-byte FCS — 11 Frame Control subfields, all four addresses resolved through the ToDS/FromDS role matrix, sequence and fragment numbers, QoS and HT Control, CRC-32 FCS PASS/FAIL — plus MANAGEMENT frame bodies: the fixed fields of 11 subtypes, the information element chain, and the nested RSN / WPA cipher and AKM suite chain with its counter checks. NOT DECODED YET: the action frame body beyond its Category field (next sub-wave). OUT OF SCOPE: radiotap / PPI / Prism / AVS headers and the pcap envelope (separate libpcap link types), control and data frame bodies, HT/VHT/HE PHY parameters, the EAPOL handshake, WEP/TKIP/CCMP decryption, A-MSDU / A-MPDU and defragmentation.',
          layer: 'data-link',
          status: 'partial',
          pluginId: 'wifi',
