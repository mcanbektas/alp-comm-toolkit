/**
 * Protokol metinleri — İngilizce. Gerekçesi için `trProtocols.ts` dosya başına
 * bakın; bu dosya onun tip zoruyla eşlenen ikizidir.
 */

import type { ProtocolTranslationDictionary } from './trProtocols';

export const enProtocols: ProtocolTranslationDictionary = {
