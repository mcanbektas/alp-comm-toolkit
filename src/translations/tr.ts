...
export const tr = {
  ...
  'monitor.source.usbHint': 'Cihaz seçimi tarayıcı izni ister; konfigürasyon/arayüz/uç nokta numaraları cihazın kendi tanımından okunur.',
  'monitor.source.bluetoothHint': 'Cihaz seçimi tarayıcı izni ister; servis ve karakteristik UUID\'leri cihazın GATT tanımından okunur.',
  ...
  'monitor.usbUnsupported': 'Bu tarayıcı WebUSB API desteklemiyor. Simülasyon kaynağını kullanabilirsiniz.',
  'monitor.bluetoothUnsupported': 'Bu tarayıcı Web Bluetooth API desteklemiyor. Simülasyon kaynağını kullanabilirsiniz.',
  ...
  'monitor.field.usbConfiguration': 'Konfigürasyon numarası',
  'monitor.field.usbInterface': 'Arayüz numarası',
  'monitor.field.usbEndpointIn': 'IN uç noktası',
  'monitor.field.usbEndpointOut': 'OUT uç noktası',
  'monitor.field.usbTransferSize': 'Transfer boyutu',
  'monitor.field.bluetoothService': 'Servis UUID',
  'monitor.field.bluetoothNotifyCharacteristic': 'Bildirim karakteristiği UUID',
  'monitor.field.bluetoothWriteCharacteristic': 'Yazma karakteristiği UUID',
